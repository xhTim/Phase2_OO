...
struct UncerAnalyzer : Analyzer
{
	...
	AnalysisData CB_Poly3_AnaData 			{	"CB_Poly3_AnaData"			,	"../signalExt/JpsiXsecValues/JpsiXsec_Default_26RapBins_ZB.root"				};
...
//	AnalysisData CB_Poly3_looseHF_AnaData 	{	"CB_Poly3_looseHF_AnaData"	,	Form("../signalExt/JpsiXsecValues/JpsiXsec_CB_Poly3_PUShuai_6RapBins%s.appliedTnP.looseHF.root", template_Name[template_option].Data())		};
	...
	AnalysisData CB_Poly3_fluxP_AnaData 	{	"CB_Poly3_fluxP_AnaData"	,	"../signalExt/JpsiXsecValues/JpsiXsec_Default_26RapBins_ZB.root"				};
	AnalysisData CB_Poly3_fluxM_AnaData 	{	"CB_Poly3_fluxM_AnaData"	,	"../signalExt/JpsiXsecValues/JpsiXsec_Default_26RapBins_ZB.root"				};
	AnalysisData CB_Poly3_fluxPM_AnaData 	{	"CB_Poly3_fluxPM_AnaData"	,	"../signalExt/JpsiXsecValues/JpsiXsec_Default_26RapBins_ZB.root"				};
	AnalysisData CB_Poly3_fluxMP_AnaData 	{	"CB_Poly3_fluxMP_AnaData"	,	"../signalExt/JpsiXsecValues/JpsiXsec_Default_26RapBins_ZB.root"				};
	AnalysisData CB_Poly3_fluxEMDP_AnaData 	{	"CB_Poly3_fluxEMDP_AnaData"	,	"../signalExt/JpsiXsecValues/JpsiXsec_Default_26RapBins_ZB.root"				};
	AnalysisData CB_Poly3_fluxEMDM_AnaData 	{	"CB_Poly3_fluxEMDM_AnaData"	,	"../signalExt/JpsiXsecValues/JpsiXsec_Default_26RapBins_ZB.root"				};
...
//-------------------------------------TIMER-------------------------------------------------------
	...
	UncerAna.Handle();
	UncerAna.SaveResults("outFiles/Result_CMS_SysUncer_ZB.root");
