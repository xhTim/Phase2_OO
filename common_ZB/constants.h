...
const int    nDiffRapBins = 26;
const double mDiffRapLow[nDiffRapBins] = {-4.0, -3.6, -3.3, -3.0, -2.7, -2.4, -2.1, -1.9, -1.6, -1.3, -1.0, -0.7, -0.4, 0.1, 0.4, 0.7, 1.0, 1.3, 1.6, 1.9, 2.1, 2.4, 2.7, 3.0, 3.3, 3.6};
const double mDiffRapHi[nDiffRapBins]  = {-3.6, -3.3, -3.0, -2.7, -2.4, -2.1, -1.9, -1.6, -1.3, -1.0, -0.7, -0.4, -0.1, 0.4, 0.7, 1.0, 1.3, 1.6, 1.9, 2.1, 2.4, 2.7, 3.0, 3.3, 3.6, 4.0};
const double mDiffRapBds[nDiffRapBins+2] = {-4.0, -3.6, -3.3, -3.0, -2.7, -2.4, -2.1, -1.9, -1.6, -1.3, -1.0, -0.7, -0.4, -0.1, 0.1, 0.4, 0.7, 1.0, 1.3, 1.6, 1.9, 2.1, 2.4, 2.7, 3.0, 3.3, 3.6, 4.0};
