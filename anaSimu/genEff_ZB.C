...
void genEff_ZB(TString FileName = "CohJpsi")
{
    TFile *inFile = new TFile("outFiles/ana_mc_" + FileName + "_ZB.root", "READ");
    ...
    TFile *fOut = new TFile("EffundTemp/Eff_" + FileName + "_ZB.root", "recreate");
